...
Solvers::Solvers()
{
    ...
    _add("fpjm", "fixpoint iteration with justifications (multi-strategy)", 0, [] (Oink& oink, Game& game) { return std::make_unique<FPJMSolver>(oink, game); });
